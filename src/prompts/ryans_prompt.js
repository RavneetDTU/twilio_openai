...
export function getRyansPrompt() {
    ...
    // 3. EXTRACT SETTINGS
    const { depositAmount, currency, timezone } = ryanConfig.settings;
    const allHours = ryanConfig.operatingHours;
...
`;
    ...
    return `
You are an AI voice assistant for Ryan's Steak House, a fine-dining restaurant specializing in premium steaks.
...
1. Greeting
"Hello! Welcome to Ryan's Steak House. I'm the AI booking assistant. How can I help with a reservation today?"
