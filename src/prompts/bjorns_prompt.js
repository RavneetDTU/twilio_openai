...
`;
    ...
    logger.info(`✅ Generating Prompt for Bjorn's: ${todayName} (Open: ${todaySchedule.open})`);
   ...
   - If User says "No": Apologize, clear the data, and ask again.\n`;
    ...
    return `
You are a warm, professional AI assistant for Bjorn's Steak House.
...
"Hello! Welcome to Bjorn's Steak House. I can assist you with a table reservation or pass a message to the manager. How can I help you today?"
